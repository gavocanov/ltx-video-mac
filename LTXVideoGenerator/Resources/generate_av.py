...
def generate_video_with_audio(
    ...
    # Load the VAE decoder up-front so it is available for mid-denoise latent
    # previews (and reused for the final decode below).
...
Examples:
  ...
  python -m mlx_video.generate_av --prompt "Waves crashing" --image beach.png --image-strength 0.8
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Emit a latent preview frame every N denoise steps (0 = off)",
    )
    parser.add_argument(
        "--preview-dir",
        type=str,
